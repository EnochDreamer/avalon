...
function SecondHero() {
  return (
  <div className='relative w-full mx-auto border rounded-lg overflow-hidden shadow h-full'>
  <img src={Funmi} alt="funmi" className='w-full h-auto object-contain sm:h-screen sm:object-cover' />
